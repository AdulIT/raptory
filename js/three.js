...
// // light1.add(pointLight2.position, 'x').min(-10).max(10).step(0.1)
...
// // Light 3
// const pointLight3 = new THREE.PointLight(0x1fe, 2)
// pointLight3.position.set(9.13, -5.5, -1.3)
...
// // light2.add(pointLight3.position, 'x').min(-10).max(10).step(0.1)
